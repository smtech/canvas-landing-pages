...
$smarty->assign('content','
    ...
    <div class="container">
        <div class="readable-width">
            ...
            <p>If you would like access to Canvas, please contact <a href="mailto:helpdesk@stmarksschool.org?subject=Canvas%20Access,%20please!">helpdesk@stmarksschool.org</a> from your school email address and we&rsquo;ll get you set up!</p>

            <h3>Are you a student in an online St. Mark&rsquo;s course?</h3>

            <p>Please contact <a href="mailto:helpdesk@stmarksschool.org?subject=Canvas%20Password%20Problem">helpdesk@stmarksschool.org</a> from the email address that you registered with us for assistance. (If you can&rsquo;t remember which email address you used, please be sure to include your full name and a good explanation of what&rsquo;s going on so we can help you figure it out!)</p>
        </div>
    </div>
');
